...
import ResourcesBanner from "../../assets/ResourcesBanner.jpg";
...
function Resources() {
    const [safetyWorkbooks, setSafetyWorkbooks] = useState([
        ...
        {
          title: "My Tenth Safety Workbook",
          class: "Class 10 (It’s On the Way)",
          price: 250,
          edition: "(For New Edition)",
  ...
  return (
    <div>
      <div>
        <img src={ResourcesBanner} alt="Resources" className="w-full h-full" />
      </div>
      <div className="w-[80%] overflow-hidden mx-auto">
        ...
        >
          <h2 className="text-sm custom-font-shoulder">
            Parents, teachers, and caregivers need to understand that children
            go through various cognitive moral development stages before they
            finally understand their actions’ long-term consequences.
          </h2>
        </div>
      </div>
...
`}
      ...
      <div className="px-40">
        <div>
          ...
          <h3 className="text-center text-2xl outfit mt-1 mb-4">Children Safety Workbooks <span className="font-semibold">(UKG To 9)</span></h3>
          <p className="quicksand text-center">To implement Project CACA in your school, kindly fill and submit the <a href="" className="text-red-600 font-semibold hover:underline">Implementation Form.</a> Here is the link for the <a href="" className="text-red-600 font-semibold hover:underline">Teacher’s Manual (Pink Book)</a> and <a href="" className="text-red-600 font-semibold hover:underline">Template</a> for lesson plan development. Besides, here is a write-up for a <a href="" className="text-red-600 font-semibold hover:underline">parent’s circular</a> about the school’s initiative to implement Project CACA.</p>
                ...
                safetyWorkbooks.map((safetybook, index)=>{
                    return (
                        <div className="card cursor-pointer text-center hover:scale-105 duration-500">
                                <div>
                                    <img src={safetybook.image} alt={safetybook.title} className="mx-auto w-[250px] h-[340px] object-cover" />
                                </div>
                                <h4 className="text-lg font-semibold outfit">{safetybook.class}</h4>
                                <p className="quicksand mb-2">Price Rs. <span>{safetybook.price}/-</span> <span>{safetybook.edition}</span></p>
