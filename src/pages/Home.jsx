...
function Home() {
  ...
  return (
    <div className="w-full h-full">
      <HomePageBanner/>
      <div className="h-full w-full py-12 px-20 md:px-8 md:py-8 xl:px-28 2xl:px-38">
        <h2 className="text-center font-bold tracking-wide text-lg custom-font-shoulder md:text-sm xl:text-lg">
        ...
        <p className="my-5 capitalize text-center quicksand font-[500] md:text-xs md:my-3 xl:text-sm xl:my-5 2xl:text-base">
        ...
        <ul className="list-decimal font-semibold grid grid-cols-2 justify-center items-center w-1/2 gap-y-2 mx-auto place-items-center md:w-[80%] xl:w-1/2">
          <li>Non-Discrimination</li>
          <li>Best Interest of the Child</li>
          <li>Survival and Development</li>
          <li>Participation/ Inclusion</li>
        </ul>
        <p className="mt-5 capitalize text-center quicksand font-[500] md:text-xs xl:text-sm 2xl:text-base">
      ...
      <div className="h-full mt-10 w-full py-12 px-36 bg-[#E8E8E8] md:px-10 md:py-10 xl:px-36 xl:py-12 2xl:px-44">
        <h3 className="text-4xl text-center ubuntu-light md:text-3xl xl:text-4xl">
          Partners & Supporters
        </h3>
        <p className="mt-8 mb-16  quicksand font-[400] md:mt-6 md:mb-8 md:text-sm xl:text-base 2xl:text-lg">
        ...
        <div className="flex justify-center gap-20 items-center">
          {partnersImage.map((item, index) => {
            return <img key={index} src={item} alt="Partners & Supporters" className="md:w-[15%]" />;
          })}
        </div>
      </div>

      <div className="h-full w-full py-12 px-36 md:px-10 xl:px-24">
        <h3 className="text-4xl text-center ubuntu-light md:text-3xl xl:text-4xl">Helplines</h3>
        <div className="grid grid-cols-3 justify-between w-full items-center mt-2 gap-y-10">
          {OutreactRcsaImage[0].map((item, index) => {
            return (
              <div key={index} className=" h-full flex flex-col justify-between items-center cursor-pointer duration-300 hover:shadow-lg ">
                ...
                />
                <h4 className="text-center text-lg font-[400] outfit text-[#5a4c4cd7] md:text-sm xl:text-lg">
                  {item.title}
                </h4>
              </div>
            );
      ...
      <div className="py-12 px-36 bg-[#F5F5F5] md:px-8 xl:px-24 ">
          <img src="https://projectcaca.org/wp-content/uploads/2021/06/New-logo-project-caca-Cop.png" alt="Project CACA" className="mx-auto md:w-1/9" />
          <h2 className="text-3xl text-center ubuntu-light my-2 text-[#755757] md:text-2xl">Project CACA Outreach/Impact</h2>
          <div className="grid grid-cols-3 justify-between w-full items-center gap-y-10">
    ...
    <div className="py-12 px-40 md:px-10 lg:px-24 xl:px-34 2xl:px-44">
      <h3 className="text-center text-3xl text-[#463838] md:text-2xl xl:text-3xl 2xl:text-4xl">CACA Schools</h3>
      <p className="text-lg quicksand mt-4 mb-1 md:text-sm xl:text-lg 2xl:text-xl">These are the schools across India that have implemented Project CACA as a safety programme under their school’s safety policy to keep children happy, healthy and safe. The project covers the entire spectrum of schools, i.e.</p>
      <ul className="quicksand md:text-sm xl:text-base 2xl:text-xl">
      ...
      >
        {cacaSchoolImage.concat(cacaSchoolImage).map((item, index) => (
          <img
            ...
            src={item}
            alt="CACA Schools"
            className="object-cover w-[10%] md:w-[2%] md:h-[50%] h-[100%]"
          />
        ))}
      </div>
