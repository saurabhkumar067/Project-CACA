...
function Home() {
  ...
  return (
    <div className="w-full h-full">
      <HomePageBanner/>
      <div className="h-full w-full py-12 px-20 md:px-8 md:py-8 xl:px-28 2xl:px-38 min-[320px]:py-4 min-[320px]:px-2">
        ...
        <p className="my-5 capitalize text-center quicksand font-[500] md:text-xs md:my-3 xl:text-sm xl:my-5 2xl:text-base min-[320px]:text-xs min-[320px]:my-3">
        ...
        <ul className="list-decimal font-semibold grid grid-cols-2 justify-center items-center w-1/2 gap-y-2 mx-auto place-items-center md:w-[80%] xl:w-1/2 min-[320px]:w-full min-[320px]:text-xs min-[320px]:grid-cols-1">
          <li>Non-Discrimination</li>
          <li>Best Interest of the Child</li>
          <li>Survival and Development</li>
          <li>Participation/ Inclusion</li>
        </ul>
        <p className="mt-5 capitalize text-center quicksand font-[500] md:text-xs xl:text-sm 2xl:text-base min-[320px]:text-xs">
      ...
      <div className="h-full mt-10 w-full py-12 px-36 bg-[#E8E8E8] md:px-10 md:py-10 xl:px-36 xl:py-12 2xl:px-44 min-[320px]:py-5 min-[320px]:px-4">
        ...
        <p className="mt-8 mb-16  quicksand font-[400] md:mt-6 md:mb-8 md:text-sm xl:text-base 2xl:text-lg min-[320px]:mt-4 min-[320px]:text-xs min-[320px]:mb-5">
        ...
        <div className="flex justify-center gap-20 items-center min-[320px]:gap-5">
      ...
      <div className="h-full w-full py-12 px-36 md:px-10 xl:px-24 min-[320px]:px-4 min-[320px]:py-6">
        <h3 className="text-4xl text-center ubuntu-light md:text-3xl xl:text-4xl min-[320px]:text-2xl">Helplines</h3>
        <div className="grid grid-cols-3 justify-between w-full items-center mt-2 gap-y-10 min-[320px]:grid-cols-1 min-[320px]:mt-5">
      ...
      <div className="py-12 px-36 bg-[#F5F5F5] md:px-8 xl:px-24 min-[320px]:px-4 min-[320px]:py-6">
          ...
          <h2 className="text-3xl text-center ubuntu-light my-2 text-[#755757] md:text-2xl min-[320px]:text-lg">Project CACA Outreach/Impact</h2>
          <div className="grid grid-cols-3 justify-between w-full items-center gap-y-10 min-[320px]:grid-cols-2 min-[320px]:gap-y-5">
    ...
    <div className="py-12 px-40 md:px-10 lg:px-24 xl:px-34 2xl:px-44 min-[320px]:px-4 min-[320px]:py-6">
      <h3 className="text-center text-3xl text-[#463838] md:text-2xl xl:text-3xl 2xl:text-4xl min-[320px]:text-lg">CACA Schools</h3>
      ...
      <ul className="quicksand md:text-sm xl:text-base 2xl:text-xl min-[320px]:text-xs">
      ...
      >
        {cacaSchoolImage.concat(cacaSchoolImage).map((item, index) => (
          <img
            ...
            src={item}
            alt="CACA Schools"
            className="object-cover w-[10%] md:w-[2%] md:h-[50%] h-[100%] min-[320px]:h-[50%]"
          />
        ))}
      </div>
