...
function OpenLetter() {
    return (
        <div className="overflow-hidden">
          ...
          <div className="px-20 mt-10 min-[320px]:px-4 sm:px-10 lg:px-20">
            <h2 className="text-4xl text-center font-semibold text-red-600 min-[320px]:text-2xl sm:text-4xl">
            Open Letter
            </h2>
    
            <div>
              <h3 className="text-base font-semibold text-center text-[#3e4142] mt-4 mb-2 min-[320px]:text-xs min-[320px]:mt-2 sm:text-base sm:mt-4">
              Dear Parent/Caregivers/ Teachers,
              </h3>
              <p className="text-center mb-5 min-[320px]:text-xs sm:text-base">
