  ...
  const [advisorsData, setadvisorsData] = useState([
    {
      ...
      profession: "Mentor (Fr. General Secretary, Council of Boards of School Education in India – COBSE):",
    ...
    },
    {
      ...
      profession:"(Co-Chair, Indian Council of Medical Research (ICMR) – Committee on Children Under Difficult Circumstances | Fr. President, Indian Academy of Paediatrics (IAP), Delhi – EB Member CIAP | Ex-member Child Welfare Committee, Delhi.)",
    ...
    },
    {
      ...
      name:"Dr. Amit Sen",
      profession:"(Director, Children First, Safdarjung; Senior Child & Adolescent Psychiatrist. MD, MRCPsych, CCST in Child & Adolescent Psychiatry):",
    ...
    },
    {
      ...
      profession:"(Professor – Dean (Research), National Council of Educational Research and Training – NCERT):",
    ...
    },
    {
      ...
      profession:"(Professor in Delhi University, Activist and Author in the field of Child Rights and Childhood Disability) :",
    ...
    },
    {
      ...
      name:"Tanuja Sharma",
      profession:"(Counselling Psychologist/School counsellor, The Indian School Muscat, Oman) :",
    ...
    },
    {
      ...
      name:"Poonam Gautam",
      profession:"(Special educator and school counsellor (Rtd.), Loreto Convent School, Delhi)",
    ...
    },
    {
      ...
      name:"Hemlata Suri",
      profession:"(Counselling Psychologist and a Special Educator; Counsellor, Carmel Convent School, Chanakyapuri, Delhi)",
    ...
    },
    {
      ...
      profession:"(Faculty Psychology, The Mother’s International School, Delhi)",
      ...
      <div className="px-20 mt-10">
        ...
        <div className="mt-6">
          {advisorsData.map((advisors, index)=>{
            return (
              <div key={index} className="flex justify-center items-center gap-5 px-3 rounded-xl py-2 mb-8 bg-gray-100 hover:bg-gray-200 duration-300">
              ...
              <div>
                <h3 className="text-xl font-semibold">{advisors.name}</h3>
                <p className="my-2 text-base outfit">
                  {advisors.profession}
                </p>
                <p className="text-sm quicksand">
                  {advisors.disc.length>400?advisors.disc.slice(0,400)+"...":advisors.disc}
                </p>
              </div>
            </div>
            )
