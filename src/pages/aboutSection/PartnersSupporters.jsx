          ...
          <div className="grid grid-cols-3 mt-5">
            {
                Partners.map((Partner, index)=>{
                    return (
                        <a key={index} href=""><img  src={Partner} alt="" className="mx-auto w-[200px]  hover:scale-110 duration-300 object-contain sm:w-[150px] xl:w-[200px]" /></a>
                    )
                })
            }
